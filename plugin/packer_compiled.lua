...
_G.packer_plugins = {
  ...
  ["go.nvim"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/go.nvim",
  ...
  neorg = {
    ...
    loaded = true,
    needs_bufread = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/opt/neorg",
  ...
  ["nvim-dap"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/nvim-dap",
    url = "https://github.com/mfussenegger/nvim-dap"
  },
  ["nvim-dap-go"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/nvim-dap-go",
  ...
  ["nvim-treesitter-context"] = {
    loaded = true,
    path = "/Users/adam/.local/share/nvim/site/pack/packer/start/nvim-treesitter-context",
